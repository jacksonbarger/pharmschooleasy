    ...
    <div className='space-y-6'>
          ...
          <CardContent className='relative p-8'>
            <div className='flex items-start justify-between'>
              <div className='space-y-3'>
                ...
                <p className='text-4xl font-black text-gray-900 dark:text-white group-hover:text-blue-600 transition-colors'>
                  {modules.length}
                </p>
              </div>
            </div>
            ...
            <div className='flex items-start justify-between'>
              <div className='space-y-3'>
                ...
                <p className='text-4xl font-black text-gray-900 dark:text-white group-hover:text-purple-600 transition-colors'>
                  {Math.round(
                    modules.reduce((acc, m) => acc + m.coverageScore, 0) / modules.length
                  )}
                  %
                </p>
              </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        {modules.map(module => (
          <Card
            key={module.id}
            className='hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-2 group'
          >
              ...
              <div className='flex items-center justify-between text-sm'>
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-bold ${
                    module.coverageScore >= 80
                      ? 'bg-green-100 text-green-800'
                      : module.coverageScore >= 60
            ...
            <CardContent>
              <div className='space-y-4'>
                ...
                <div className='flex justify-between text-sm text-gray-600 dark:text-gray-400'>
                  ...
                  {module.lastStudied && <span>Last: {module.lastStudied}</span>}
                </div>
          ...
          <CardContent className='relative p-12 flex flex-col items-center justify-center h-full min-h-[400px] text-center'>
            ...
            <div className='space-y-4 mb-8'>
              ...
              <div className='flex flex-wrap justify-center gap-2 mt-4'>
                <span className='px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-2xl text-sm font-bold'>
                  Pancreas
                </span>
                <span className='px-4 py-2 bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 rounded-2xl text-sm font-bold'>
                  Kidneys
                </span>
                <span className='px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-2xl text-sm font-bold'>
                  Heart
                </span>
              </div>
            </div>
