    ...
    <div className='min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden'>
      ...
      <div className='relative flex h-screen'>
              ...
              return (
                ...
                >
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    <ChevronRight
                      className={`h-4 w-4 text-white/40 transition-transform ${isActive ? 'rotate-90' : ''}`}
                    />
                  </div>
                </button>
              );
        ...
        <div className='flex-1 overflow-auto'>
          {activeTab === 'ai-tools' && <AITutoringInterface />}
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
                  {[
                    ...
                    return (
                      <Card
                        key={index}
                        className='bg-white/10 backdrop-blur-2xl border border-white/20 hover:bg-white/15 transition-all duration-300'
                      >
                ...
                <div className='space-y-4'>
                  ...
                  <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6'>
                    {moduleCards.map(module => (
                      <Card
                        key={module.id}
                        className='group bg-white/10 backdrop-blur-2xl border border-white/20 hover:bg-white/15 hover:border-white/30 transition-all duration-500 overflow-hidden'
                      >
                        ...
                        <CardContent className='p-6 space-y-4'>
                          ...
                          <div className='flex gap-3 pt-2'>
                            ...
                            <Button
                              className={`px-4 bg-gradient-to-r ${module.color} hover:shadow-lg`}
                            >
                      ...
                      {[
                        {
                          ...
                          module: 'Liver Metabolism',
                          time: '2 hours ago',
                          score: '95%',
                        },
                        {
                          action: 'Studied topic',
                        ...
                        <div
                          key={index}
                          className='flex items-center justify-between p-3 bg-white/5 rounded-xl backdrop-blur-xl'
                        >
                          <div className='flex items-center gap-3'>
