  ...
  const getPerformanceMessage = (percentage: number) => {
    ...
    if (percentage >= 80)
      return {
        ...
        description: 'Great understanding with minor areas to review.',
      };
    if (percentage >= 70)
      return {
        emoji: '👍',
    ...
    return {
      ...
      description: 'Focus on reviewing the core concepts.',
    };
  };
            ...
            <div className='bg-white/10 backdrop-blur-xl rounded-3xl p-8 space-y-3'>
              ...
              <div className='space-y-1'>
                ...
                <p className='text-sm text-purple-200'>
                  {session.score} of {session.totalQuestions} correct
                </p>
              </div>
            </div>
          ...
          <CardContent className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              {['easy', 'medium', 'hard'].map(difficulty => {
                const difficultyQuestions = session.questions.filter(
