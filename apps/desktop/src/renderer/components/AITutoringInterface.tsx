...
export function AITutoringInterface() {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: 'assistant',
      content: "👋 Hello! I'm your AI pharmacy tutor. I can help you with drug mechanisms, clinical applications, side effects, interactions, and more. What would you like to learn about today?",
      timestamp: new Date()
    }
  ])
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const pharmacyContext = "You are a pharmacy tutor. Provide educational, accurate information about drugs, mechanisms, interactions, and clinical applications. Focus on learning objectives for pharmacy students."
